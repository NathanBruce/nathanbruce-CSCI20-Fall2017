...
cleaned up spacing and text
changed the num value in loop to "sum" so the counter would work as intended
rearranged the input in the loop to collect num instead of sum
